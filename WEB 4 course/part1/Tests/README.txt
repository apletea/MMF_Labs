...
В этой директории Денвер хранит скрипты самотестирования.

Внимание: файлы располагаются именно здесь, в /home/localhost/,
а не в /denwer/www, потому что иначе людям будет очень трудно
"сделать по аналогии" - маппинх URL на пути неочевиден.
